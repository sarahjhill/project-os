...
window.CONFIG = {
  ...
  /* ------------------------------------------------------------------
     ...
     To get yours:
       ...
       2. New Project  →  New Form.  Name it "The SJH Dragon Fire Process".
  ...
  /* ------------------------------------------------------------------
     ...
     ------------------------------------------------------------------
     Switches on sign-in and the client portal. Without it, The SJH Dragon Fire Process
  ...
  ------------------------------------------------------------------ */
  studioName: 'The SJH Dragon Fire Process'
};
