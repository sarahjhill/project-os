...
window.CONFIG = {
  ...
  /* ------------------------------------------------------------------
     ...
     To get yours:
       ...
       2. New Project  →  New Form.  Name it "The Dragon Fire Process".
  ...
  ------------------------------------------------------------------ */
  appUrl: 'https://sarahjhill.com/project-os/app.html',
  ...
  /* ------------------------------------------------------------------
     ...
     ------------------------------------------------------------------
     Switches on sign-in and the client portal. Without it, The Dragon Fire Process
  ...
  ------------------------------------------------------------------ */
  studioName: 'The Dragon Fire Process'
};
